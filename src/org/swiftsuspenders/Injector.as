...
package org.swiftsuspenders
{
    ...
    public class Injector
    {
        ...
        *******************************************************************************************/
        ...
        /**
         * removes all the references of an Object from the Injector
         * to be able to unload swift files properly.
         *
         * @param target The object to remove the references of
         */
        public function removeInjectionReferencesOf(target : Object):void
        {
            if (m_attendedToInjectees[target] != null)
            {
                var description : XML = describeType(target.constructor);
                delete m_attendedToInjectees[target];
                delete m_injectionPointLists[target.constructor];
                delete m_injectionPointLists[description.@name.toString()];
                delete m_constructorInjectionPoints[target.constructor];
            }
        }
